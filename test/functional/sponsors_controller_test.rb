...
class SponsorsControllerTest < ActionController::TestCase
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post :create, sponsor: { description: @sponsor.description, email: @sponsor.email, name: @sponsor.name, sponsor_type_id: @sponsor.sponsor_type_id, website: @sponsor.website }
    end
  ...
  test "should update sponsor" do
    put :update, id: @sponsor, sponsor: { description: @sponsor.description, email: @sponsor.email, name: @sponsor.name, sponsor_type_id: @sponsor.sponsor_type_id, website: @sponsor.website }
    assert_redirected_to sponsor_path(assigns(:sponsor))
  end
